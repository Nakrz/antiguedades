...
INSERT INTO pais (id_pais, nombre_pais) VALUES (4, 'México');
INSERT INTO pais (id_pais, nombre_pais) VALUES (5, 'Perú');
...
INSERT INTO ciudad (id_ciudad, nombre_ciudad, id_region) VALUES (3, 'Bogotá', 3);
...
INSERT INTO ciudad (id_ciudad, nombre_ciudad, id_region) VALUES (7, 'Valparaíso', 1);
...
INSERT INTO rol (id_rol, nombre_rol) VALUES (3, 'Empleado');
INSERT INTO rol (id_rol, nombre_rol) VALUES (4, 'Visita');
INSERT INTO rol (id_rol, nombre_rol) VALUES (5, 'Proveedor');
...
INSERT INTO categorias (id_categoria, nombre_categoria) VALUES (1, 'Antigüedades');
...
INSERT INTO administrador (id_administrador, nombre_administrador, apellido_administrador, correo) VALUES (1, 'Juan', 'Pérez', 'juan.perez@example.com');
INSERT INTO administrador (id_administrador, nombre_administrador, apellido_administrador, correo) VALUES (2, 'María', 'González', 'maria.gonzalez@example.com');
INSERT INTO administrador (id_administrador, nombre_administrador, apellido_administrador, correo) VALUES (3, 'Luis', 'Martínez', 'luis.martinez@example.com');
INSERT INTO administrador (id_administrador, nombre_administrador, apellido_administrador, correo) VALUES (4, 'Ana', 'Fernández', 'ana.fernandez@example.com');
...
INSERT INTO empleado (id_empleado, nombre_empleado, apellido_empleado, correo_empleado, telefono_empleado, id_jefe) VALUES (2, 'Laura', 'Martínez', 'laura.martinez@example.com', 987654321, 1);
INSERT INTO empleado (id_empleado, nombre_empleado, apellido_empleado, correo_empleado, telefono_empleado, id_jefe) VALUES (3, 'Pedro', 'García', 'pedro.garcia@example.com', 555555555, 2);
INSERT INTO empleado (id_empleado, nombre_empleado, apellido_empleado, correo_empleado, telefono_empleado, id_jefe) VALUES (4, 'Lucía', 'Hernández', 'lucia.hernandez@example.com', 444444444, 2);
INSERT INTO empleado (id_empleado, nombre_empleado, apellido_empleado, correo_empleado, telefono_empleado, id_jefe) VALUES (5, 'Javier', 'Jiménez', 'javier.jimenez@example.com', 333333333, 3);

INSERT INTO cliente (id_cliente, nombre_cliente, apellido_cliente, correo_cliente, telefono_cliente, rol, id_ciudad) VALUES (1, 'Pedro', 'Sánchez', 'pedro.sanchez@example.com', 123123123, 2, 1);
...
INSERT INTO cliente (id_cliente, nombre_cliente, apellido_cliente, correo_cliente, telefono_cliente, rol, id_ciudad) VALUES (3, 'Jorge', 'Suárez', 'jorge.suarez@example.com', 456456456, 2, 3);
...
INSERT INTO epoca_antiguedad (id_epoca, nombre_epoca) VALUES (4, 'Contemporáneo');
INSERT INTO epoca_antiguedad (id_epoca, nombre_epoca) VALUES (5, 'Antiguo');

INSERT INTO antiguedades (id_antiguedad, nombre_antiguedad, id_categoria, id_disponibilidad, id_ranking, id_epoca, origen, estado_conservacion, precio, id_administrador) VALUES (1, 'Vase Precolombino', 1, 1, 3, 1, 'Perú', 'Bueno', 1500.00, 1);
...
INSERT INTO antiguedades (id_antiguedad, nombre_antiguedad, id_categoria, id_disponibilidad, id_ranking, id_epoca, origen, estado_conservacion, precio, id_administrador) VALUES (5, 'Escultura Contemporánea', 2, 1, 5, 4, 'México', 'Nuevo', 4500.00, 1);
...
INSERT INTO metodo_pago (id_metodo_pago, nombre_metodo_pago) VALUES (1, 'Tarjeta de Crédito');
